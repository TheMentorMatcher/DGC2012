...
Description: The best way to embed Flash Player and Flash movie in your Wordpress Blog. Includes GPL Flowplayer, OS FLV player, and MediaElement.js. Usage: <code>[hana-flv-player video='/source_video.flv' /]</code>
Version: 2.9.3
Author: HanaDaddy
...
if (typeof g_hanaFlash !== 'undefined' && !g_hanaFlash){
	...
	jQuery('#$flow3_id').html(\"<span class='inactive_message' style='display:block'>$inactive_message</span> ".str_replace('"','\"',$description). "\");
		...
		// mediaelement 
			...
			//preload='.$preload.'&amp;
			$output.="<hana-ampersand><div style='padding:0;margin:0; border:0;'><video  id='$media_id' $youtube src='".$flv_attr['video']."' width='".$flv_attr['width']."' height='".$flv_attr['height']."' $splashImage 
...
<div class='division'>
	...
	<table id="optiontable" class="editform">
		<tr>
			...
			NOTE:To support Apple devices, you must select Mediaelement.js. Also remember to encode video using h.264 mp4 ecoding since Apple browsers do not support FLV encodings.  
...
<p>When you defined any attribute, please make sure that you use single or double quotes around the attribute value, or my plugin may not recognize the attribute. 
	...
	<ul style='list-style-type: circle;padding-left:20px;margin:10px' >
		...
		<li><strong>player</strong>: If set to "1" , <a href='http://www.osflv.com/'>OS FLV</a> will be used. 
			...
			"4" is for <a href='http://flowplayer.org'>FlowPlayer 3(3.2.3)</a>.
...
?>
   ...
   //This is for quicktag HTML mode (refering to wp-includes/js/quicktags.dev.js)
	...
	jQuery(document).ready(function () {
		jQuery('#dialog_hanaflv').jqm({ toTop:true} );
	});
